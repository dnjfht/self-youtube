    ...
    >
      <div className="w-10/12 h-[100%] py-[20px] box-border mx-auto flex justify-between items-center">
        ...
        >
          <input
            className={`${
              focusOn ? "w-[86%] pl-10" : "w-5/6 pl-5"
            } h-[100%] py-5 pr-5 box-border rounded-l-full outline-none bg-transparent border-[1px] border-solid border-[#e8a0a0]`}
            type="text"
            placeholder="검색"
            onChange={(e) => {
          ...
          />
          <div className={`${focusOn ? "opacity-"}`}
          "absolute top-[50%] mt-[-11px] left-3 text-[1.4rem] text-[#e8a0a0]">
            <CiSearch />
          </div>
          <button>
            <BsSearchHeart />
