      ...
      <div className="w-10/12 h-[100%] py-[20px] box-border mx-auto flex justify-between items-center">
        ...
        >
          <input
            className={`${
              focusOn
                ? "w-[86%] pl-10 border-[#6e7ee1] placeholder:text-[#6e7ee1]"
                : "w-5/6 pl-5 border-[#e8a0a0] placeholder:text-[#e8a0a0]"
            } h-[100%] py-5 pr-5 box-border rounded-l-full outline-none bg-transparent border-[1px] border-solid`}
            type="text"
            placeholder="검색"
            onChange={(e) => {
          ...
          <div
            ...
            } absolute top-[50%] mt-[-11px] left-3 text-[1.4rem] text-[#6e7ee1] transition-all duration-700`}
          >
            <CiSearch />
          </div>
          <button>
