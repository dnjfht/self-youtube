...
export default function Navbar() {
  ...
  return (
    <div
      className={`${
        darkMode ? "bg-[#282828] text-white" : "bg-[#ffc2c246] text-[#282828]"
      } w-full h-[100px]`}
    >
      <div className="w-10/12 h-[100%] py-[20px] box-border mx-auto flex justify-between items-center">
        ...
        >
          ...
          <button className="w-14 h-full border-y-[1px] border-r-[1px] border-solid border-[#e8a0a0] flex justify-center items-center rounded-r-full">
            <BsSearchHeart />
          </button>
        </form>
