...
export default function Navbar() {
  ...
  return (
    <div
      className={`${
        darkMode ? "bg-[#000000] text-white" : "bg-[#ffc2c274] text-[#282828]"
      } w-full h-[100px]`}
    >
      <div className="w-10/12 h-[100%] py-[20px] box-border mx-auto flex justify-between items-center">
        ...
        >
          <input
            className="w-5/6 h-[100%] p-5 box-border rounded-l-full outline-none bg-transparent border-[1px] border-solid border-[#bd6e6e]"
            type="text"
            placeholder="검색"
            onChange={(e) => {
