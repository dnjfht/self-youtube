    ...
    >
      <div className="w-10/12 h-[100%] py-[20px] box-border mx-auto flex justify-between items-center">
        ...
        >
          ...
          <div
            className={`${focusOn ? "right-[19.4%]" : "right-[21.2%]"} ${
              text.length > 0 ? "right-[18.8%]" : "right-[15.4%]"
          ...
          <div
            className={`${
              text.length > 0 ? "opacity-100 right-0" : "opacity-0 right-0"
            } ${
              focusOn ? "right-[15.4%]" : "right-[18.4%]"
