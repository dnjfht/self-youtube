      ...
      <div className="w-10/12 h-[100%] py-[20px] box-border mx-auto flex justify-between items-center">
        ...
        >
          <input
            ...
            } h-[100%] py-5 pr-5 box-border rounded-l-full outline-none bg-transparent border-[1px] border-solid text-[#cd6f6f] text-[1.1rem] leading-1 placeholder:text-[#e8a0a0]`}
            type="text"
            placeholder="검색"
            onChange={(e) => {
