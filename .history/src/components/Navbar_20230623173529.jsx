      ...
      <div className="w-10/12 h-[100%] py-[20px] box-border mx-auto flex justify-between items-center">
        ...
        >
          <input
            className={`${
              focusOn ? "w-[86%]" : "w-5/6"
            } h-[100%] p-5 box-border rounded-l-full outline-none bg-transparent border-[1px] border-solid border-[#e8a0a0] relative`}
            type="text"
            placeholder="검색"
            onChange={(e) => {
          ...
          />
          <div className="absolute top-0 left-0">{focusOn && <CiSearch />}</div>
          <button>
            <BsSearchHeart />
          </button>
        </form>
